...
fig = ggplot(tabX) + 
  ...
  labs(x = "Flowering duration", y = "Average MaxGER") +
  ylim(0,1) +
...
fig = ggplot(tabX) + 
  ...
  geom_point()  + 
  labs(x = "Maximal height", y = "Average MaxGER") + ylim(0,1)
...
fig = ggplot(tabX) + 
  ...
  geom_boxplot(outlier.shape = NA) +
  labs(x = "Beginning of flowering period", y = "Average MaxGER") +
  ylim(0,1) 
...
fig = ggplot(tabX) + 
  ...
  geom_point()  + 
  labs(x = "Maximal height", y = "Average LER") + ylim(0,1)
...
fig = ggplot(tabX) + 
  ...
  geom_boxplot(outlier.shape = NA) +
  labs(x = "Beginning of flowering period", y = "Average LER") +
  ylim(0,1) 
