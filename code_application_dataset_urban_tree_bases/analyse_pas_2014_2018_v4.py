...
for selected_plant in liste_especes_2014_2018 :
    ...
    for l in plant_files:
        O = np.loadtxt(f"donnees_occurence_2014_2018/{l}", delimiter=',')
    ...
    if USE_SAVE:
        ...
        estimation_result = src.estimation.estimate_multiple_streets(observations, H_max=10, niter=50000)
