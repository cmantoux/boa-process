...
EXP = 22 # experiment number (used for the seed)
...
N_range     = [30, 50, 100]
T_range     = [5, 10]
p_ext_range = np.linspace(-0.1, 0.1, 11) # p_ext centered around p_c[H]
H_range     = [0, 1, 2, 5]
s_range     = [0.2, 0.8]
...
for i, H in enumerate(H_range):
    ...
    f = open(os.environ["B"]+f"/E{EXP}_results_{H}.pkl", "wb")
