...
EXP = 7 # experiment number (used for the seed)
...
H_range     = [0, 1, 2, 5]
s_range     = [0.2, 0.8]
eps_range   = [0.0, 0.01, 0.02, 0.05] # noisy BOA
...
for sim_index in tqdm(sim_indices):
    ...
    result_array.data[a, b, c, d, e, f, g, results.index("GER")] = test_1
    result_array.data[a, b, c, d, e, f, g, results.index("MaxGER")] = test_2
...
f = open(os.environ["B"]+f"/E{EXP}_results_nonnoisy.pkl", "wb")
...
for sim_index in tqdm(sim_indices):
    ...
    result_array.data[a, b, c, d, e, f, g, results.index("GER")] = test_1
    result_array.data[a, b, c, d, e, f, g, results.index("MaxGER")] = test_2
    result_array.data[a, b, c, d, e, f, g, results.index("eps_mean")] = hist["eps"].mean()
    result_array.data[a, b, c, d, e, f, g, results.index("eps_std")] = hist["eps"].std()
    result_array.data[a, b, c, d, e, f, g, results.index("rmse_eps")] = rmse_eps
    for h in range(H_max+1):
        result_array.data[a, b, c, d, e, f, g, results.index(f"p(H={h})")] = H_probs[h]
        result_array.data[a, b, c, d, e, f, g, results.index(f"s_{h}_mean")] = hist["s_mean"][h]
        result_array.data[a, b, c, d, e, f, g, results.index(f"s_{h}_rmse")] = hist["s_rmse"][h]
...
f = open(os.environ["B"]+f"/E{EXP}_results_noisy.pkl", "wb")
pickle.dump(result_array, f)
f.close()
